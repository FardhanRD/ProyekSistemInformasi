            ...
            <div class="relative flex h-full flex-col justify-between p-8 text-accent-primary">
                <div class="inline-flex items-center gap-2 rounded-full bg-white/75 px-4 py-2 text-sm font-semibold tracking-widest frost">
                    <span class="inline-flex -space-x-2">
                        <img class="h-9 w-9 rounded-full border-2 border-white object-cover" src="https://randomuser.me/api/portraits/women/25.jpg" alt="user">
                        <img class="h-9 w-9 rounded-full border-2 border-white object-cover" src="https://randomuser.me/api/portraits/men/66.jpg" alt="user">
                        <img class="h-9 w-9 rounded-full border-2 border-white object-cover" src="https://randomuser.me/api/portraits/women/31.jpg" alt="user">
                    </span>
                ...
                <div>
                    ...
                    <p class="mt-3 text-lg text-white/90">Build your account and start your MOVR journey</p>
                </div>
            </div>
        </div>
        ...
        <div class="relative bg-white px-7 py-10 sm:px-10 lg:px-11">
            <div class="mx-auto max-w-md">
                <div class="mb-8 text-center">
                    ...
                    <h1 class="mt-4 text-4xl font-bold tracking-tight text-gray-900">Create account</h1>
                    <p class="mt-2 text-sm text-gray-500">Please fill in your details to continue</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name') }}" required class="mt-2 w-full border-0 border-b border-gray-300 bg-transparent px-0 pb-3 pt-1 text-gray-900 placeholder:text-gray-400 focus:border-gray-900 focus:outline-none focus:ring-0" />
                    </div>
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password" required class="mt-2 w-full border-0 border-b border-gray-300 bg-transparent px-0 pb-3 pt-1 text-gray-900 placeholder:text-gray-400 focus:border-gray-900 focus:outline-none focus:ring-0" />
                    </div>
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="font-bold text-gray-900 hover:underline">Login</a>
                </p>
